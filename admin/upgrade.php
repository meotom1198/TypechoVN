            ...
            <div class="col-mb-12">
                <div id="typecho-welcome">
                    <form action="<?php echo $security->getTokenUrl(
                        ...
                        <ul>
                            <li><?php _e('Bạn đã cập nhật lên phiên bản Typecho mới nhất nhưng vẫn cần thực hiện một số bước để hoàn tất nâng cấp!'); ?></li>
                        ...
                        <p>
                            <button class="btn primary" type="submit"><?php _e('Hoàn tất &raquo;'); ?></button>
                        </p>
                    </form>
                </div>
            </div>
