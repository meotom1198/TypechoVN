                ...
                <div class="typecho-list-operate clearfix">
                    <form method="get">
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('Bạn có chắc chắn muốn xóa những trang độc lập này?'); ?>"
                                    ...
                                    <li>
                                        <a href="<?php $security->index('/action/contents-page-edit?do=mark&status=hidden'); ?>"><?php _e('<strong>%s</strong>', _t('Ẩn trang độc lập')); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="search" role="search">
                            ...
                            <button type="submit" class="btn btn-s"><?php _e('Lọc theo từ khóa'); ?></button>
                        </div>
                    </form>
                                    ...
                                    <tr id="<?php $pages->theId(); ?>">
                                        ...
                                        <td>
                                            ...
                                            if ('hidden' == $pages->status) {
                                                echo '<em class="status">' . _t('Ẩn trang độc lập') . '</em>';
                                            }
                                            ?>
