            ...
            <div class="col-mb-12 col-tb-8" role="main">
                ...
                <div id="upload-panel" class="p">
                    <div class="upload-area"
                         draggable="true"><?php _e('Thả tập tin vào đây <br>hoặc %schọn tệp để tải lên%s', '<a href="###" class="upload-file">', '</a>'); ?></div>
                    <ul id="file-list"></ul>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function fileUploadError(error) {
            ...
            switch (code) {
                case plupload.FILE_SIZE_ERROR:
                    word = '<?php _e('Kích thước tập tin quá lớn!'); ?>';
                    break;
        ...
        function fileUploadComplete(id, url, data) {
            ...
            $('#' + id).text('<?php _e('Tập tin %s đã được thay thế'); ?>'.replace('%s', data.title))
