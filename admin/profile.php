    ...
    <div class="body container">
        ...
        <div class="row typecho-page-main">
            <div class="col-mb-12 col-tb-3">
                ...
                <li><?php
                    if ($user->logged > 0) {
                        ...
                        _e('Login lần cuối: %s', $logged->word());
                    }
                    ?></li>
                    </ul>
            </div>
            ...
            <div class="col-mb-12 col-tb-6 col-tb-offset-1 typecho-content-panel" role="form">
                <section>
                    <h3><i class="fa fa-user" aria-hidden="true"></i> <?php _e('Sửa thông tin cá nhân'); ?></h3>
                ...
                <?php if ($user->pass('contributor', true)): ?>
                    ...
                    <section id="writing-option">
                        <h3><i class="fa fa-book" aria-hidden="true"></i> <?php _e('Cài đặt đăng bài'); ?></h3>
                ...
                <section id="change-password">
                    <h3><i class="fa fa-key" aria-hidden="true"></i> <?php _e('Đổi mật khẩu'); ?></h3>
