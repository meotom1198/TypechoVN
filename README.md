...
# :arrow_forward: :earth_asia: :earth_asia: :earth_asia: Wellcome to Typecho VN :earth_asia: :earth_asia: :earth_asia: :arrow_backward:

:arrow_forward: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia:  :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :earth_asia: :arrow_backward:

---

# **:wave: Mã nguồn Typecho VN :wave:**
1. **Cảm ơn mọi người rất nhiều!** Vì đã chọn **Mã Nguồn Typecho VN** để sử dụng và xây dựng blog/website của các bạn. Mình tin rằng, với các tính năng mà **Mã Nguồn Typecho VN** đem lại, chắc chắn sẽ đáp ứng tốt nhu cầu của xây dựng blog/website cá nhân của mọi người! **Mã Nguồn Typecho VN** có mức độ tuỳ chỉnh/tuỳ biến rất cao, **Mã Nguồn Typecho VN** còn có thể tải lên và `Kích hoạt` các *Plugin* hoặc *Theme* khác để giúp **Mã Nguồn Typecho VN** trở nên hay ho và đa dụng hơn nữa!
2. **Trang chủ: [Typecho VN](https://typechovn-render-com.onrender.com)** 
3. **Liên hệ: [Facebook](https://www.faecebook.com/cu.ti.9212)**

---

## **Ⅰ. :hammer: Giới thiệu về Typecho VN**
...
* **Ảnh chụp màn hình**
![Typecho Việt Hoá](https://wapvn.top/usr/themes/joe-plus/screenshot.png)
...
# :arrow_forward: :earth_asia: :earth_asia: :earth_asia: :earth_asia: ️εɳ∂เɳɠ σƒ รเƭε :earth_asia: :earth_asia: :earth_asia: :earth_asia: :arrow_backward:
