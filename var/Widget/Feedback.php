...
class Feedback extends Comments implements ActionInterface
{
    ...
    public function action()
    {
        ...
        if (
            ...
            if ('trackback' == $callback && !$this->content->allow('ping')) {
                throw new Exception(_t('Trang này không cho phép trích dẫn!'), 403);
            }
    ...
    private function comment()
    {
        ...
        $validator->addRule('url', 'url', _t('Địa chỉ Facebook bạn vừa điền không đúng định dạng!'));
        $validator->addRule('url', 'maxLength', _t('Địa chỉ Facebook có thể chứa tối đa 255 ký tự!'), 255);
