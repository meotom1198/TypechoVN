...
class Login extends Users implements ActionInterface
{
    ...
    public function action()
    {
        ...
        $validator->addRule('name', 'required', _t('Nhập tài khoản'));
        $validator->addRule('password', 'required', _t('Nhập mật khẩu'));
        $expire = 30 * 24 * 3600;
        ...
        if (!$valid) {
            ...
            Cookie::set('__typecho_remember_name', $this->request->name);
            Notice::alloc()->set(_t('Tài khoản hoặc mật khẩu không chính xác!'), 'error');
