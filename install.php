...
// Download Page Official: https://wapvn.top
...
function install_get_default_options(): array
{
    ...
    if (empty($options)) {
        $options = [
            ...
            'title' => 'Typecho VN',
            'description' => 'WapVN.Top Là Một Blog Cá Nhân, Chuyên Hỗ Trợ Typecho Việt Hoá, Chuyên Chia Sẻ Code, Chia Sẻ Mã Nguồn, Code PHP Script, Nhạc, Meme, Font Chữ Đẹp, Typecho Việt Hoá 1.2.1, Typecho Việt Hoá',
            'keywords' => 'typecho vn 121, typecho vn 1.2.1, typecho viet hoa, typecho vn, typecho việt nam, wapvn.top, blog wapvn.top, upload.wapvn.top, upload, wapupload, upload file miễn phí, typecho viet hoa, php, blog, wapvn.top, blog wapvn.top, font chữ, meme, nhạc, typecho vh, typecho viet hoa 121, typecho viet hoa 1.2.1, download typecho viet hoa 121, download typecho viet hoa 1.2.1, typecho vh 121, typecho vh 1.2.1, download typecho vh 121, download typecho vh 1.2.1, typecho.org, typecho.org việt hoá, typecho 1.2.1 việt hoá, typecho 121 việt hoá',
            'rewrite' => 0,
            'frontPage' => 'recent',
            'frontArchive' => 0,
    ...
    <div id="success" class="row typecho-page-main hidden">
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="typecho-page-title">
                <h2 align="center"><?php _e('Cài đặt mã nguồn Typecho VN'); ?></h2>
            </div>
            <div id="typecho-welcome">
                <p class="keep-word">
                    <?php _e('Bạn đã chọn sử dụng dữ liệu trong database cũ, để có thể đăng nhập vào "Trung tâm điều khiển" bạn cần sử dụng tài khoản và mật khẩu Admib trong database trước đó.'); ?>
                </p>
                <p class="fresh-word">
                ...
                <ul>
                    <li><a id="login-url" href=""><?php _e('<b style="color:orange;">Trung tâm điều khiển</b>'); ?></a></li>
                    <li><a id="site-url" href=""><?php _e('<b style="color:blue;">Về trang chủ</b>'); ?></a></li>
                </ul>
                <p  align="center"><?php _e('Mình hy vọng rằng, bạn sẽ thích mã nguồn <b style="color:blue;">Typecho VN</b> và giới thiệu mã nguồn <b style="color:blue;">Typecho VN</b> với nhiều người hơn nữa, để cộng đồng người sử dụng mã nguồn <b style="color:blue;">Typecho VN</b> lớn mạnh hơn! Cảm ơn bạn rất nhiều!'); ?></p>
            </div>
        </div>
    </div>
    <script>
...
function install_check_extension(array $extensions): ?string
{
    ...
    return _n('Có hàm PHP cần thiết chưa được bật.', 'Vui lòng bật các hàm sau để mã nguồn Typecho VN hoạt động ổn định nhất.', count($extensions))
        . ': ' . implode(', ', $extensions);
}
...
function install_step_1()
{
    ...
    <div class="row typecho-page-main">
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="typecho-page-title">
                <h2 align="center"><?php _e('Cài đặt Typecho VN'); ?></h2>
            </div>
            <div id="typecho-welcome">
                <form autocomplete="off" method="post" action="install.php">
                    <h3><?php _e('<i class="fa-solid fa-circle-info"></i> HÃY DÀNH RA 1 PHÚT ĐỂ ĐỌC "LỜI NÓI ĐẦU" ĐI ĐÃ RỒI HÃY BẮT ĐẦU CÀI ĐẶT MÃ NGUỒN "TYPECHO VN"'); ?></h3>
                    <h4 style="color:violet;"><i class="fa-solid fa-list"></i> <b>Lời nói đầu:</b></h4>
                     <ol>
                        <?php _e('
                      <li>Đây là mã nguồn <b>Typecho 1.2.1 gốc</b>, mình tải tại <a href="https://typecho.org/download" title="Download Typecho Official"><u style="color:red;">Typecho.Org</u></a>, và đã được <a href="https://facebook.com/cu.ti.9212" title="Luyện Phạm"><b style="color:violet;">Luyện Phạm</b></a> Việt Hóa full. Gần như không còn 1 chữ Trung Quốc nào trong mã nguồn!
                      </li>
                      <li>LƯU Ý: Mình <b style="color:black;">KHÔNG</b> chịu trách nhiệm nếu bạn download, hoặc tải về tại bất kỳ <i>blog</i> hay <i>diễn đàn</i> nào khác ngoài <a href="https://wapvn.top" title="wapvn.top"><b style="color:orange;">WAPVN.TOP</b></a>. Vì khi bạn tải <b>Typecho VN</b> ở trang khác, rất có thể <b>Typecho VN</b> ở đó đã bị gắn mã độc-shell-v.v..., nên mình không hỗ trợ khi bạn tải <b>Typecho VN</b> từ nơi khác.
                      </li>
                      <li>Hãy tải <b>Typecho VN</b> tại <a href="https://wapvn.top" title="wapvn.top"><b style="color:orange;">WAPVN.TOP</b></a> để yên tâm về vấn đề bảo mật. Mã nguồn <b>Typecho VN</b> tại <a href="https://wapvn.top" title="wapvn.top"><b style="color:orange;">WAPVN.TOP</b></a> không hề có mã độc-shell-v.v.... Mình xin khẳng định!
                      </li>
                      <li><b>Typecho VN</b> là <b><i>dự án phi lợi nhuận</b></i> được thực hiện bởi: <a href="https://facebook.com/cu.ti.9212" title="Luyện Phạm"><b style="color:blue;">Luyện Phạm</b></a>. Nên các <i>blog</i> hoặc <i>diễn đàn</i> khác, khi leech về để chia sẻ cho thành viên của mình, vui lòng <b style="color:black;">KHÔNG</b> rao bán, <b style="color:black;">KHÔNG</b> chèn ADS vào link download, <b style="color:black;">KHÔNG</b> cài mã độc vào <b>Typecho VN</b>. Xin cảm ơn!
                      </li>
                      <li>Hãy bấm nút "Thiết Lập Database <i class="fa-solid fa-play"></i>" để bắt đầu quá trình cài đặt mã nguồn <b>Typecho VN</b> nhé!
                      </li>
                      <li>
                          Xin cảm ơn!
                      </li>
...
function install_step_1_perform()
{
    ...
    if (!$writeable) {
        $errors[] = _t('Không thể tạo thư mục uploads. Vui lòng chỉnh quyền của thư mục %s trong thư mục cài đặt để có thể tạo và tiếp tục nâng cấp.', $uploadDir);
    }
...
function install_step_2()
{
    ...
    <div class="row typecho-page-main">
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="typecho-page-title">
                <h2 align="center"><?php _e('Thiết lập database'); ?></h2>
            </div>
            <div id="typecho-welcome">
            <form autocomplete="off" action="install.php" method="post">
                <ul class="typecho-option">
                    <li>
                        ...
                        <p class="description"><?php _e('ㅤ+ Hãy chọn loại database'); ?></p>
                ...
                <ul class="typecho-option">
                    <li>
                        ...
                        <input type="text" class="text" name="dbPrefix" id="dbPrefix" value="typechovn_" />
                        <p class="description"><?php _e('ㅤ+ Nếu bạn không sửa thì tiền tố mặc định là "typechovn_"'); ?></p>
                    </li>
                </ul>
...
function install_step_2_perform()
{
    ...
    $error = (new \Typecho\Validate())
        ->addRule('dbPrefix', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
        ->addRule('dbPrefix', 'minLength', _t('Hãy kiểm tra lại thông tin database của bạn'), 1)
        ->addRule('dbPrefix', 'maxLength', _t('Hãy kiểm tra lại thông tin database của bạn'), 16)
        ->addRule('dbPrefix', 'alphaDash', _t('Hãy kiểm tra lại thông tin database của bạn'))
        ->addRule('dbAdapter', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
        ->addRule('dbAdapter', 'enum', _t('Hãy kiểm tra lại thông tin database của bạn'), array_keys($drivers))
        ->addRule('dbNext', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
        ->addRule('dbNext', 'enum', _t('Hãy kiểm tra lại thông tin database của bạn'), ['none', 'delete', 'keep', 'config'])
        ->run($config);
    ...
    switch ($type) {
        case 'Mysql':
            $error = (new \Typecho\Validate())
                ->addRule('dbHost', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbPort', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbPort', 'isInteger', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbUser', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbCharset', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbCharset', 'enum', _t('Hãy kiểm tra lại thông tin database của bạn'), ['utf8', 'utf8mb4'])
                ->addRule('dbDatabase', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbEngine', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbEngine', 'enum', _t('Hãy kiểm tra lại thông tin database của bạn'), ['InnoDB', 'MyISAM'])
                ->addRule('dbSslCa', 'file_exists', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbSslVerify', 'enum', _t('Hãy kiểm tra lại thông tin database của bạn'), ['on', 'off'])
                ->run($config);
            break;
        case 'Pgsql':
            $error = (new \Typecho\Validate())
                ...
                ->addRule('dbUser', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbCharset', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->addRule('dbCharset', 'enum', _t('Hãy kiểm tra lại thông tin database của bạn'), ['utf8'])
                ->addRule('dbDatabase', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->run($config);
            break;
        case 'SQLite':
            $error = (new \Typecho\Validate())
                ->addRule('dbFile', 'required', _t('Hãy kiểm tra lại thông tin database của bạn'))
                ...
                }, _t('Hãy kiểm tra lại thông tin database của bạn'))
                ->run($config);
            break;
        default:
            install_raise_error(_t('Hãy kiểm tra lại thông tin database của bạn'));
            break;
    }
    ...
    if ($config['dbNext'] == 'config' && !install_check('config')) {
        ...
        install_raise_error(_t('Không tìm thấy tập tin config.inc.php bạn tạo thủ công, vui lòng kiểm tra và tạo lại.'), ['code' => $code]);
        ...
        if (!install_check('config')) {
            install_raise_error(
                _t('Quá trình cài đặt không thể tự tạo tập tin <strong>config.inc.php</strong>!') . "\n" .
                _t('Bạn có thể fix bằng cách tạo tập tin <strong>config.inc.php</strong> trên hosting hoặc máy chủ, sau đó sao chép và dán đoạn code dưới vào: '),
                [
                'code' => $code
                ]
            );
...
function install_step_3()
{
    ...
    <div class="row typecho-page-main">
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="typecho-page-title">
                <h2 align="center"><?php _e('Thiết lập tài khoản Admin'); ?></h2>
            </div>
            <form autocomplete="off" action="install.php" method="post">
                <ul class="typecho-option">
                    <li>
                        ...
                        <p class="description"><?php _e('ㅤ+ Đây là tên miền được mã nguồn <b style="color:blue;">Typecho VN</b> tự động điền. Nếu tên miền mà mã nguồn <b style="color:blue;">Typecho VN</b> tự động điền chưa chính xác, bạn có thể sửa lại tên miền của website trong <b>Trang trung tâm</b>.'); ?></p>
                    </li>
                </ul>
                <ul class="typecho-option">
                    <li>
                        <label class="typecho-label" for="userName"><?php _e('<b style="color:red;"><i class="fa-solid fa-user"></i></b> Tài khoản'); ?></label>
                        <input autocomplete="new-password" type="text" name="userName" id="userName" class="text" />
                        <p class="description"><?php _e('ㅤ+ Vui lòng điền tên tài khoản <b>Admin</b>'); ?></p>
                    </li>
                </ul>
                <ul class="typecho-option">
                    <li>
                        <label class="typecho-label" for="userPassword"><?php _e('<b style="color:red;"><i class="fa-solid fa-key"></i></b> Mật khẩu'); ?></label>
                        <input type="password" name="userPassword" id="userPassword" class="text" />
                        <p class="description"><?php _e('ㅤ+ Vui lòng điền mật khẩu của tài khoản <b>Admin</b>, nếu để trống hệ thống sẽ tạo ngẫu nhiên mật khẩu cho tài khoản <b style="color:red;">Admin</b> của bạn'); ?></p>
                    </li>
                </ul>
                <ul class="typecho-option">
                    <li>
                        <label class="typecho-label" for="userMail"><?php _e('<b style="color:red;"><i class="fa-solid fa-envelope"></i></b> Email'); ?></label>
                        <input autocomplete="new-password" type="text" name="userMail" id="userMail" class="text" />
                        <p class="description"><?php _e('ㅤ+ Hãy điền địa chỉ email để thiết lập làm email chính của tài khoản <b>Admin</b>'); ?></p>
                    </li>
                </ul>
                <ul class="typecho-option typecho-option-submit">
                    <li>
...
function install_step_3_perform()
{
    ...
    $error = (new \Typecho\Validate())
        ...
        ->addRule('userMail', 'required', _t('Vui lòng điền địa chỉ Email!'))
        ->addRule('userMail', 'email', _t('Địa chỉ Email không đúng định dạng!'))
        ->addRule('userMail', 'maxLength', _t('Email bạn vừa điền quá dài, không vượt quá 200 ký tự!'), 200)
        ->run($config);
    ...
    try {
        ...
        $installDb->query(
            $installDb->insert('table.metas')
                ->rows([
                    'name' => _t('Danh mục cha'),
                    'slug' => 'danh-muc-cha',
                    'type' => 'category',
                    'description' => _t('Đây là mô tả mặc định của Danh mục cha.'),
                    'count' => 1
                ])
        );
        ...
        $installDb->query(
            $installDb->insert('table.contents')->rows([
                'title' => _t('Cài đặt thành công mã nguồn Typecho VN'),
                'slug' => 'start', 'created' => \Typecho\Date::time(),
                'modified' => \Typecho\Date::time(),
                'text' => '<!--markdown-->' . _t('<center>
![Blog WapVN.TOP](https://wapvn.top/images/logo.png) 
</center>
　Xin chúc mừng! Bạn đã cài đặt thành công <b style="color:blue;">Typecho VN</b> được cập nhật và chia sẻ miễn phí tại [**WAPVN.TOP**](https://wapvn.top).

# Cài Đặt Thành Công Typecho VN
## Chúc mừng
1. Nếu bạn nhìn thấy bài viết đầu tiên này, tức là hosting hoặc máy chủ của bạn đã được cài đặt thành công <b style="color:blue;">Typecho VN 1.2.1</b>
2. Bạn có thể vào **Trang trung tâm** và bắt đầu chỉnh sửa blog của bạn ngay bây giờ.
3. Bạn nên bắt đầu theo các bước ở dưới trước.

### Bắt đầu
<b style="color:violet;">Bạn nên thiết lập những hướng dẫn cài đặt bên dưới đây trước:</b>
1. Vào <b>Trang trung tâm</b> => <b>Cài đặt</b> => <b>Kiểu URL</b>, để tuỳ chỉnh kiểu URL mà bạn muốn.
2. Vào <b>Trang trung tâm</b> => <b>Plugins</b> và kích hoạt các plugin các plugin cần thiết sau: *Menu Tree => Cài đặt => Chế độ độc lập*, *waterMark => sửa link logo của bạn*, *DownloadFile*.
3. Vào <b>Trang trung tâm</b> => <b>Themes</b> => <b>Cài Đặt Theme</b> và tuỳ chỉnh các thông tin mà bạn cần như: *Thông báo*, *Hiệu ứng Animation*, *Ngày tạo blog*, *Logo*, *Logo Darkmode*, *v.v...*
4. Vào <b>Trang trung tâm</b> => <b>Cài Đặt</b> => <b>Cơ Bản</b>, để sửa *tiêu đề blog*, *mô tả blog*, *các từ khoá cho blog*, *bật/tắt đăng ký tài khoản*, *múi giờ*, *v.v...*
5. Còn lại tuỳ bạn chỉnh sửa nha.

#### Nâng cao
<b style="color:violet;">Dưới đây là các bước tiếp theo:</b>
1. Vào <b>Trang trung tâm</b> => <b>Quản lý</b> => <b>Danh mục</b>, để bắt đầu thêm các danh mục của bạn (vào <a href=" https://wapvn.top/plugins-typecho/" title="Plugin Typecho"><b style="color:blue;">đây</b></a> để tìm thêm Plugin Việt Hóa).
2. Vào <b>Trang trung tâmn</b> => <b>Cài đặt</b> => <b>Bình luận</b>, tích vào những ô sau: *Bắt buộc phải có email*, *Bắt buộc phải điền link profile*, *Bật phân trang....*. Đổi định dạng ngày giờ thành `F jS, Y \a\t h:i a`.
3. Vào <b>Trang trung tâm</b> => <b>Cá nhân</b> => <b>Thay Đổi Avatar</b>, để thay đổi avatar cho tài khoản của bạn.
4. Vào <a href=" https://wapvn.top/themes-typecho/" title="Themes Typecho"><b style="color:blue;">đây</b></a> hoặc <a href=" https://wapvn.top/themes-joeplus/" title="Theme Joe+"><b style="color:blue;"> vào đây</b></a> để tìm thêm theme, sau đó vào <b>Trang trung tâm</b> => <b>Themes</b> => <b>Cài Đặt Theme</b> => <b>Giới hạn ký tự mỗi bình luận</b>, để cài đặt số ký tự cho mỗi bình luận, nên đặt là <b>30</b>.
5. Còn lại tuỳ bạn chỉnh sửa nha.

##### Blog WapVN.TOP
- Ủng hộ mình bằng cách thêm <i>text link</i> vào cuối website, hoặc ghi nguồn như sau: <i>Share bởi: <b style="color:violet;">MeoDiLac - WapVN.Top</b></i> nha!
- Bạn có thể ủng hộ mình bằng cách khác là, giới thiệu blog <a href="https://wapvn.top" title="wapvn.top"><b style="color:blue;">WapVN.TOP</b></a> với bạn bè và người thân.
- Bạn nên <b style="color:ornge;">Upload File</b> + <b style="color:blue;">Lưu Trữ File</b> tại <a href="https://upload.wapvn.top" title="upload.wapvn.top"><b style="color:blue;">Upload.WapVN.TOP</b></a>. Vì <a href="https://upload.wapvn.top" title="upload.wapvn.top"><b style="color:blue;">Upload.WapVN.TOP</b></a> là website <b style="color:orange;">Upload File</b> + <b style="color:blue;">Lưu Trữ File</b> hoàn toàn miễn phí.'),
                'authorId' => 1,
                'type' => 'post',
                'status' => 'publish',
                'commentsNum' => 1,
...
# Giới thiệu
1. Đây là trang mặc định, được tạo tự động sau khi bạn cài đặt thành công <b style="color:blue;">Typecho VN</b>, được cập nhật và chia sẻ miễn phí tại [**WAPVN.TOP**](https://wapvn.top).
2. Bạn có thể <b>sửa</b> hoặc <b>xoá</b> trang mặc định này tại **Bảng điều khiển** => **Quản lý** => **Trang**.
3. Bạn có thể <b style="color:orange;">Upload File</b> + <b style="color:blue;">Lưu Trữ File</b> tại <a href="https://upload.wapvn.top" title="upload.wapvn.top"><b style="color:blue;">Upload.WapVN.TOP</b></a>. Vì <a href="https://upload.wapvn.top" title="upload.wapvn.top"><b style="color:blue;">Upload.WapVN.TOP</b></a> là website <b style="color:orange;">Upload File</b> + <b style="color:blue;">Lưu Trữ File</b> hoàn toàn miễn phí.
4. Hãy tải <b style="color:blue;">Typecho VN</b> tại <a href="https://wapvn.top" title="wapvn.top"><b style="color:violet;">WapVN.TOP</b></a> để có thể yên tâm về vấn đề bảo mật.
5. Xin cảm ơn!'),
                'authorId' => 1,
                'order' => 0,
                'type' => 'page',
        ...
        $installDb->query(
            $installDb->insert('table.comments')->rows([
                ...
                'text' => 'Đây là "Bình luận mặc định" được tạo tự động sau khi mã nguồn "Typecho VN" được cài đặt thành công lên hosting hoặc máy chủ của bạn! Bạn có thể "xoá" hoặc "sửa bình luận" này trong "Trang trung tâm"! Bạn có thể tìm thêm nhiềuThemes Đã Việt Hoá cực đẹp và Plugins Việt Hoá tại WAPVN.TOP. Các nội dung được chia sẻ trên WAPVN.TOP là hoàn toàn miễn phí.',
                'type' => 'comment',
                'status' => 'approved',
                'parent' => 0
            ])
...
<head>
    ...
    <title><?php _e('Cài đặt Typecho VN'); ?></title>
...
<body>
    <div class="body container">
        <h1 align="center"><a href="/" target="_blank"><img src="/images/logo.png" title="WapVN.Top" /></a></h1> <!-- width="390" height="auto"-->
        <?php $method(); ?>
    </div>
</body>
</html>
